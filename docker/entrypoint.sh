#!/bin/bash
# CHYing Agent — Tool Container Entrypoint
# Starts background services (PostgreSQL/Metasploit, GhidraMCP), then keeps container alive.
# Main program runs on host, invokes container tools via docker exec.

set -e

# ============================================================
# 1. Start PostgreSQL + Metasploit database
# ============================================================
